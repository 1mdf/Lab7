...
/**
 * @author Michelangelo Della Flora
...
public class RPSLSpock {
     ...
     * @return checks if your pick is one of the valid choices
     */
    ...
    /**
     * @return makes a random pick for the computer
     */
     ...
     * @return returns whether the computer or player wins
     */
